...
void main ()
{
  ...
  tmpvar_18 = (tmpvar_17 * (_FrezPow * 0.000976563));
  lowp vec4 tmpvar_19;
  tmpvar_19 = textureCube (_Cube, worldRefl);
  CubeTex = tmpvar_19;
  float tmpvar_20;
  tmpvar_20 = clamp ((_Reflection + tmpvar_18), 0.0, 1.0);
  CubeTex.xyz = (tmpvar_19.xyz * tmpvar_20);
  lowp float tmpvar_21;
  tmpvar_21 = dot (CubeTex.xyz, vec3(0.22, 0.707, 0.071));
  lowp float tmpvar_22;
  tmpvar_22 = (tmpvar_21 * tmpvar_21);
  tmpvar_11 = _Shininess;
  float tmpvar_23;
  tmpvar_23 = clamp ((xlat_mutable__Color.w + tmpvar_22), 0.0, 1.0);
  lowp vec3 tmpvar_24;
  tmpvar_24 = (xlat_mutable__Color.xyz * (1.0 - tmpvar_20));
  ...
  tmpvar_26 = dot (tmpvar_12, xlv_TEXCOORD5);
  lowp float tmpvar_27;
  tmpvar_27 = max (tmpvar_26, (abs (tmpvar_26) - tmpvar_23));
  lowp float tmpvar_28;
  tmpvar_28 = dot (tmpvar_12, normalize ((xlv_TEXCOORD5 + viewDir)));
  nh = tmpvar_28;
  mediump float tmpvar_29;
  tmpvar_29 = max (0.0, nh);
  nh = tmpvar_29;
  mediump float tmpvar_30;
  tmpvar_30 = (pow (tmpvar_29, (tmpvar_11 * 128.0)) * clamp ((_Gloss + tmpvar_18), 0.0, 1.0));
  mediump vec3 tmpvar_31;
  tmpvar_31 = ((((tmpvar_24 * _LightColor0.xyz) * tmpvar_27) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_30)) * 2.0);
  c_i0_i1.xyz = tmpvar_31;
  c_i0_i1.w = clamp ((tmpvar_23 + ((_LightColor0.w * _SpecColor.w) * tmpvar_30)), 0.0, 1.0);
  c = c_i0_i1;
  c.xyz = (c_i0_i1.xyz + (tmpvar_24 * xlv_TEXCOORD6));
  c.xyz = (c.xyz + mix (CubeTex.xyz, (CubeTex.xyz * mix (xlat_mutable__Color.xyz, vec3(1.0, 1.0, 1.0), vec3(tmpvar_22))), vec3(_Metalics)));
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  tmpvar_15 = abs (dot (worldRefl, tmpvar_14));
  SurfAngle = tmpvar_15;
  lowp float tmpvar_16;
  tmpvar_16 = pow ((1.0 - SurfAngle), _FrezFalloff);
  xlat_mutable__Color.w = (xlat_mutable__Color.w * (1.0 - (tmpvar_16 * _EdgeAlpha)));
  lowp vec4 tmpvar_17;
  tmpvar_17 = textureCube (_Cube, worldRefl);
  CubeTex = tmpvar_17;
  float tmpvar_18;
  tmpvar_18 = clamp ((_Reflection + (tmpvar_16 * (_FrezPow * 0.000976563))), 0.0, 1.0);
  CubeTex.xyz = (tmpvar_17.xyz * tmpvar_18);
  lowp float tmpvar_19;
  tmpvar_19 = dot (CubeTex.xyz, vec3(0.22, 0.707, 0.071));
  lowp float tmpvar_20;
  tmpvar_20 = (tmpvar_19 * tmpvar_19);
  c = vec4(0.0, 0.0, 0.0, 0.0);
  c.xyz = ((xlat_mutable__Color.xyz * (1.0 - tmpvar_18)) * (2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD5).xyz));
  c.w = clamp ((xlat_mutable__Color.w + tmpvar_20), 0.0, 1.0);
  c.xyz = (c.xyz + mix (CubeTex.xyz, (CubeTex.xyz * mix (xlat_mutable__Color.xyz, vec3(1.0, 1.0, 1.0), vec3(tmpvar_20))), vec3(_Metalics)));
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  lowp float tmpvar_28;
  tmpvar_28 = max (tmpvar_27, (abs (tmpvar_27) - tmpvar_23));
  ...
  tmpvar_31 = (pow (tmpvar_30, (tmpvar_11 * 128.0)) * clamp ((_Gloss + tmpvar_18), 0.0, 1.0));
  ...
  c_i0_i1.w = clamp ((tmpvar_23 + (((_LightColor0.w * _SpecColor.w) * tmpvar_31) * tmpvar_25)), 0.0, 1.0);
  c = c_i0_i1;
  c.xyz = (c_i0_i1.xyz + (tmpvar_24 * xlv_TEXCOORD6));
  c.xyz = (c.xyz + mix (CubeTex.xyz, (CubeTex.xyz * mix (xlat_mutable__Color.xyz, vec3(1.0, 1.0, 1.0), vec3(tmpvar_22))), vec3(_Metalics)));
  gl_FragData[0] = c;
...
void main ()
{
  ...
  tmpvar_20 = (tmpvar_19 * tmpvar_19);
  c = vec4(0.0, 0.0, 0.0, 0.0);
  c.xyz = ((xlat_mutable__Color.xyz * (1.0 - tmpvar_18)) * min ((2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD5).xyz), vec3((texture2DProj (_ShadowMapTexture, xlv_TEXCOORD7).x * 2.0))));
  c.w = clamp ((xlat_mutable__Color.w + tmpvar_20), 0.0, 1.0);
  c.xyz = (c.xyz + mix (CubeTex.xyz, (CubeTex.xyz * mix (xlat_mutable__Color.xyz, vec3(1.0, 1.0, 1.0), vec3(tmpvar_20))), vec3(_Metalics)));
  gl_FragData[0] = c;
}
...
Program "fp" {
// Fragment combos: 4
//   opengl - ALU: 45 to 73, TEX: 3 to 5
//   d3d9 - ALU: 47 to 79, TEX: 4 to 6
SubProgram "opengl " {
Keywords { "DIRECTIONAL" "LIGHTMAP_OFF" "SHADOWS_OFF" }
...
RSQ R4.w, R4.w;
MAD R5.xyz, R4.w, fragment.texcoord[4], R4;
MUL R4.xyz, R3, c[0];
DP3 R5.w, R5, R5;
MOV R4.w, c[4].x;
MAD_SAT R4.w, R2, c[10].z, R4;
RSQ R5.w, R5.w;
MUL R5.xyz, R5.w, R5;
DP3 R2.x, R2, R5;
MOV R2.w, c[11];
...
MAD_SAT result.color.w, R4, R0, R1;
END
...
dp3 r0.w, r0, r3
mul r1.xyz, r0, r0.w
mad r1.xyz, -r1, c10.x, r3
dp3 r0.w, r1, r1
rsq r0.w, r0.w
mul r1.xyz, r0.w, r1
dp3_pp r0.x, r1, r0
abs_pp r0.x, r0
add_pp r1.w, -r0.x, c10
pow_pp r0, r1.w, c7.x
mov_pp r0.w, r0.x
mov_pp r0.x, c3
add_pp r0.y, c10.w, -r0.x
mul_pp r3.w, r0, c6.x
mov_pp r0.x, c5
mul_pp r1.w, r0.y, c11.x
mad_pp_sat r4.x, r3.w, c10.z, r0
texldl r0.xyz, r1, s2
mul_pp r3.xyz, r4.x, r0
mov_pp r1.x, c10.w
mad_pp r4.y, -r0.w, c8.x, r1.x
dp3_pp r1.x, r3, c11.yzww
texld r0, v0, s1
mul_pp r2.w, r1.x, r1.x
mul_pp r1, r0, c2
dp3_pp r0.w, r2, v5
mad_pp_sat r1.w, r1, r4.y, r2
abs_pp r0.x, r0.w
add_pp r4.y, r0.x, -r1.w
max_pp r4.w, r0, r4.y
rsq_pp r4.z, r4.z
mov_pp r0.xyz, v5
mad_pp r0.xyz, r4.z, v4, r0
dp3_pp r0.w, r0, r0
rsq_pp r0.w, r0.w
mul_pp r0.xyz, r0.w, r0
dp3_pp r0.x, r2, r0
mov_pp r0.w, c3.x
add_pp r4.x, -r4, c10.w
mul_pp r4.xyz, r1, r4.x
mul_pp r2.y, c12, r0.w
max_pp r2.x, r0, c12
pow_pp r0, r2.x, r2.y
mov_pp r0.y, c4.x
mad_pp_sat r2.x, r3.w, c10.z, r0.y
mov_pp r0.w, r0.x
mov_pp r0.xyz, c0
mul_pp r0.w, r0, r2.x
mul_pp r0.xyz, c1, r0
...
add_pp r0.xyz, -r1, c10.w
mad_pp r0.xyz, r2.w, r0, r1
mul_pp r4.xyz, r4, v6
mad_pp r1.xyz, r2, c10.x, r4
mad_pp r0.xyz, r3, r0, -r3
mov_pp r2.x, c0.w
mad_pp r0.xyz, r0, c9.x, r3
mul_pp r2.x, c1.w, r2
...
dcl_cube s2
dcl_2d s3
def c7, 2.00000000, -1.00000000, 0.00097656, 1.00000000
...
mad_pp_sat r3.x, r0, c7.z, r0.y
texldl r0.xyz, r1, s2
mul_pp r0.xyz, r3.x, r0
dp3_pp r2.w, r0, c8.yzww
texld r1, v0, s1
mul_pp r1, r1, c0
add_pp r2.xyz, -r1, c7.w
mul_pp r2.w, r2, r2
...
TXP R5.x, fragment.texcoord[7], texture[3], 2D;
...
mul_pp r0.xyz, r4, c0
mad_pp r2.xyz, r0, r4.w, r2
add_pp r0.yzw, -r1.xxyz, c10.w
mad_pp r1.xyz, r2.w, r0.yzww, r1
texldp r0.x, v7, s3
mov_pp r0.y, c0.w
mad_pp r1.xyz, r3, r1, -r3
mul_pp r0.y, c1.w, r0
mul_pp r0.y, r3.w, r0
...
def c8, 1.00000000, 6.00000000, 0, 0
...
dp3_pp r0.x, r1, r0
abs_pp r0.x, r0
add_pp r1.w, -r0.x, c8.x
pow_pp r0, r1.w, c4.x
mov_pp r3.y, r0.x
mov_pp r0.y, c1.x
add_pp r0.z, c8.x, -r0.y
...
void main ()
{
  ...
  tmpvar_11 = _Shininess;
  float tmpvar_22;
  tmpvar_22 = clamp ((xlat_mutable__Color.w + (tmpvar_21 * tmpvar_21)), 0.0, 1.0);
  lowp vec3 tmpvar_23;
  tmpvar_23 = (xlat_mutable__Color.xyz * (1.0 - tmpvar_20));
  mediump vec3 tmpvar_24;
  ...
  lowp float tmpvar_28;
  tmpvar_28 = max (tmpvar_27, (abs (tmpvar_27) - tmpvar_22));
  lowp float tmpvar_29;
  ...
  c_i0_i1.xyz = tmpvar_32;
  c_i0_i1.w = clamp ((tmpvar_22 + (((_LightColor0.w * _SpecColor.w) * tmpvar_31) * atten)), 0.0, 1.0);
  c = c_i0_i1;
  c.w = 0.0;
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  lowp float tmpvar_26;
  tmpvar_26 = max (tmpvar_25, (abs (tmpvar_25) - tmpvar_22));
  lowp float tmpvar_27;
  tmpvar_27 = dot (tmpvar_12, normalize ((lightDir + viewDir)));
  nh = tmpvar_27;
  mediump float tmpvar_28;
  tmpvar_28 = max (0.0, nh);
  nh = tmpvar_28;
  mediump float tmpvar_29;
  tmpvar_29 = (pow (tmpvar_28, (tmpvar_11 * 128.0)) * clamp ((_Gloss + tmpvar_18), 0.0, 1.0));
  mediump vec3 tmpvar_30;
  tmpvar_30 = ((((tmpvar_23 * _LightColor0.xyz) * tmpvar_26) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_29)) * 2.0);
  c_i0_i1.xyz = tmpvar_30;
  c_i0_i1.w = clamp ((tmpvar_22 + ((_LightColor0.w * _SpecColor.w) * tmpvar_29)), 0.0, 1.0);
  c = c_i0_i1;
  c.w = 0.0;
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  c_i0_i1.xyz = tmpvar_30;
  c_i0_i1.w = clamp ((tmpvar_22 + (((_LightColor0.w * _SpecColor.w) * tmpvar_29) * atten)), 0.0, 1.0);
  c = c_i0_i1;
  c.w = 0.0;
  gl_FragData[0] = c;
}
...
Program "fp" {
// Fragment combos: 5
//   opengl - ALU: 63 to 74, TEX: 3 to 5
//   d3d9 - ALU: 69 to 77, TEX: 4 to 6
SubProgram "opengl " {
Keywords { "POINT" }
Vector 0 [_LightColor0]
Vector 1 [_SpecColor]
...
POW R1.x, R1.x, c[7].x;
MOV R0.w, c[9].z;
MAD R2.w, -R1.x, c[8].x, R0;
MUL R1.w, R1.x, c[6].x;
MOV R0.w, c[5].x;
MAD_SAT R3.x, R1.w, c[9].w, R0.w;
TEX R0.xyz, R0, texture[2], CUBE;
MUL R0.xyz, R3.x, R0;
DP3 R0.y, R0, c[10];
DP3 R0.w, fragment.texcoord[4], fragment.texcoord[4];
RSQ R0.x, R0.w;
MUL R1.xyz, R0.x, fragment.texcoord[4];
MUL R3.z, R0.y, R0.y;
TEX R0, fragment.texcoord[0], texture[1], 2D;
MUL R0, R0, c[2];
DP3 R3.y, R2, R1;
MAD_SAT R2.w, R0, R2, R3.z;
ABS R0.w, R3.y;
ADD R0.w, R0, -R2;
MAX R0.w, R3.y, R0;
ADD R2.w, -R3.x, c[9].z;
...
pow_pp r0, r1.w, c7.x
mov_pp r0.y, c9.w
mad_pp r3.y, -r0.x, c8.x, r0
mov_pp r0.z, c3.x
add_pp r0.y, c9.w, -r0.z
mul_pp r2.w, r0.x, c6.x
mul_pp r1.w, r0.y, c10.x
mov_pp r0.w, c5.x
mad_pp_sat r3.x, r2.w, c9.z, r0.w
texldl r0.xyz, r1, s2
mul_pp r0.xyz, r3.x, r0
dp3_pp r0.y, r0, c10.yzww
dp3_pp r0.w, v4, v4
rsq_pp r0.x, r0.w
mul_pp r1.xyz, r0.x, v4
mul_pp r3.z, r0.y, r0.y
texld r0, v0, s1
mul_pp r0, r0, c2
mad_pp_sat r3.y, r0.w, r3, r3.z
dp3_pp r1.w, r2, r1
abs_pp r0.w, r1
add_pp r0.w, r0, -r3.y
dp3_pp r3.z, v5, v5
...
pow_pp r0, r1.x, r1.y
mov_pp r0.y, c4.x
mad_pp_sat r1.x, r2.w, c9.z, r0.y
mov_pp r0.w, r0.x
mov_pp r0.xyz, c0
mul_pp r0.xyz, c1, r0
mul_pp r0.w, r0, r1.x
...
DP3 R1.z, R0, c[10];
MUL R2.w, R1.z, R1.z;
MAD R1.y, -R0.w, c[8].x, R1;
TEX R0, fragment.texcoord[0], texture[1], 2D;
MUL R0, R0, c[2];
MAD_SAT R1.y, R0.w, R1, R2.w;
...
mov_pp r0.w, r0.x
mov_pp r0.x, c3
add_pp r0.y, c9.w, -r0.x
dp3_pp r3.y, v5, v5
mul_pp r2.w, r0, c6.x
mov_pp r0.x, c5
mad_pp_sat r3.x, r2.w, c9.z, r0
mul_pp r1.w, r0.y, c10.x
texldl r0.xyz, r1, s2
mul_pp r0.xyz, r3.x, r0
dp3_pp r1.y, r0, c10.yzww
mov_pp r1.x, c9.w
mad_pp r1.x, -r0.w, c8, r1
texld r0, v0, s1
dp3_pp r1.w, r2, v4
mul_pp r0, r0, c2
mul_pp r1.y, r1, r1
mad_pp_sat r1.x, r0.w, r1, r1.y
abs_pp r0.w, r1
add_pp r0.w, r0, -r1.x
max_pp r0.w, r1, r0
add_pp r1.w, -r3.x, c9
...
mov_pp r1.w, c3.x
max_pp r2.x, r1, c11
mul_pp r2.y, c11, r1.w
pow_pp r1, r2.x, r2.y
mov_pp r1.y, c4.x
mad_pp_sat r2.x, r2.w, c9.z, r1.y
mov_pp r1.w, r1.x
mov_pp r1.xyz, c0
mul_pp r1.w, r1, r2.x
mul_pp r1.xyz, c1, r1
...
pow_pp r1, r2.x, r2.y
mov_pp r1.y, c4.x
mad_pp_sat r2.x, r2.w, c10.z, r1.y
mov_pp r1.w, r1.x
mov_pp r1.xyz, c0
mul_pp r1.xyz, c1, r1
mul_pp r1.w, r1, r2.x
...
mov_pp r0.w, r0.x
mov_pp r0.y, c3.x
add_pp r0.x, c9.w, -r0.y
mul_pp r1.w, r0.x, c10.x
texldl r0.xyz, r1, s2
dp3_pp r3.z, v5, v5
mul_pp r2.w, r0, c6.x
mov_pp r3.x, c5
mad_pp_sat r1.w, r2, c9.z, r3.x
mul_pp r0.xyz, r1.w, r0
mov_pp r1.x, c9.w
mad_pp r3.x, -r0.w, c8, r1
dp3_pp r0.x, r0, c10.yzww
...
void main ()
{
  ...
  tmpvar_20 = (tmpvar_19 * tmpvar_19);
  float tmpvar_21;
  tmpvar_21 = clamp ((xlat_mutable__Color.w + tmpvar_20), 0.0, 1.0);
  lowp vec3 tmpvar_22;
  tmpvar_22 = (xlat_mutable__Color.xyz * (1.0 - tmpvar_18));
  ...
  tmpvar_23 = c_i0_i1;
  c = tmpvar_23;
  c.xyz = (c.xyz + (tmpvar_22 * xlv_TEXCOORD5));
  c.xyz = (c.xyz + mix (CubeTex.xyz, (CubeTex.xyz * mix (xlat_mutable__Color.xyz, vec3(1.0, 1.0, 1.0), vec3(tmpvar_20))), vec3(_Metalics)));
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  tmpvar_20 = (tmpvar_19 * tmpvar_19);
  c = vec4(0.0, 0.0, 0.0, 0.0);
  c.xyz = ((xlat_mutable__Color.xyz * (1.0 - tmpvar_18)) * (2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD4).xyz));
  c.w = clamp ((xlat_mutable__Color.w + tmpvar_20), 0.0, 1.0);
  c.xyz = (c.xyz + mix (CubeTex.xyz, (CubeTex.xyz * mix (xlat_mutable__Color.xyz, vec3(1.0, 1.0, 1.0), vec3(tmpvar_20))), vec3(_Metalics)));
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  tmpvar_27 = ((tmpvar_22 * _LightColor0.xyz) * ((tmpvar_26 * atten_i0) * 2.0));
...
void main ()
{
  ...
  tmpvar_20 = (tmpvar_19 * tmpvar_19);
  c = vec4(0.0, 0.0, 0.0, 0.0);
  c.xyz = ((xlat_mutable__Color.xyz * (1.0 - tmpvar_18)) * min ((2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD4).xyz), vec3((texture2DProj (_ShadowMapTexture, xlv_TEXCOORD6).x * 2.0))));
  c.w = clamp ((xlat_mutable__Color.w + tmpvar_20), 0.0, 1.0);
  c.xyz = (c.xyz + mix (CubeTex.xyz, (CubeTex.xyz * mix (xlat_mutable__Color.xyz, vec3(1.0, 1.0, 1.0), vec3(tmpvar_20))), vec3(_Metalics)));
  gl_FragData[0] = c;
}
...
Program "fp" {
// Fragment combos: 4
//   opengl - ALU: 45 to 53, TEX: 3 to 5
//   d3d9 - ALU: 47 to 56, TEX: 3 to 5
SubProgram "opengl " {
Keywords { "DIRECTIONAL" "LIGHTMAP_OFF" "SHADOWS_OFF" }
Vector 0 [_LightColor0]
Vector 1 [_Color]
...
ADD R2.xyz, -R0, c[7].y;
MUL R3.w, R3, R3;
MAD R2.xyz, R3.w, R2, R0;
MAD R2.xyz, R1, R2, -R1;
MAD R1.xyz, R2, c[6].x, R1;
MAD R1.w, -R1, c[5].x, R4.x;
...
MAD R3.xyz, R2, R3, -R2;
MAD R2.w, -R2, c[5].x, R4.y;
MAD_SAT R0.w, R0, R2, R3;
ADD R1.y, R1.x, -R0.w;
ADD R1.x, -R1.w, c[7].y;
MAX R1.y, R1.z, R1;
MUL R0.xyz, R0, R1.x;
...
mul_pp r6.x, r0, c3
mov_pp r2.x, c2
mad_pp_sat r2.x, r6, c7.w, r2
mul_pp r3.xyz, r3, r2.x
dp3_pp r6.x, r3, c8
add_pp r2.x, -r2, c7.z
mad_pp r0.x, -r0, c5, r0.z
mul_pp r6.x, r6, r6
mad_pp_sat r0.x, r5.w, r0, r6
mad_pp r6.xyz, r6.x, r7, r5
abs_pp r7.x, r1
add_pp r7.x, r7, -r0
max_pp r1.x, r1, r7
mul_pp r1.x, r1, r4
...
mad_pp r6.xyz, r3, r6, -r3
mov_pp r0.w, r0.x
mad_pp r2.xyz, r6, c6.x, r3
add_pp r0.xyz, r1, r2
mov_pp oC0, r0
"
}
...
void main ()
{
  ...
  tmpvar_19 = dot (CubeTex.xyz, vec3(0.22, 0.707, 0.071));
  float tmpvar_20;
  tmpvar_20 = clamp ((xlat_mutable__Color.w + (tmpvar_19 * tmpvar_19)), 0.0, 1.0);
  lowp vec3 tmpvar_21;
  tmpvar_21 = (xlat_mutable__Color.xyz * (1.0 - tmpvar_18));
  ...
  NdotL = tmpvar_26;
  lowp float tmpvar_27;
  tmpvar_27 = max (NdotL, (abs (NdotL) - tmpvar_20));
  mediump vec3 tmpvar_28;
  tmpvar_28 = ((tmpvar_21 * _LightColor0.xyz) * ((tmpvar_27 * atten) * 2.0));
...
void main ()
{
  ...
  tmpvar_24 = max (NdotL, (abs (NdotL) - tmpvar_20));
  mediump vec3 tmpvar_25;
  tmpvar_25 = ((tmpvar_21 * _LightColor0.xyz) * (tmpvar_24 * 2.0));
...
void main ()
{
  ...
  lightDir = tmpvar_22;
  lowp float tmpvar_23;
  tmpvar_23 = texture2D (_LightTexture0, ((xlv_TEXCOORD5.xy / xlv_TEXCOORD5.w) + 0.5)).w;
  lowp float tmpvar_24;
  highp vec3 LightCoord_i0;
  ...
  lightDir_i0 = lightDir;
  mediump float atten;
  atten = ((float((xlv_TEXCOORD5.z > 0.0)) * tmpvar_23) * tmpvar_24);
  lowp vec4 c_i0_i1;
  lowp float NdotL;
  ...
  NdotL = tmpvar_27;
  lowp float tmpvar_28;
  tmpvar_28 = max (NdotL, (abs (NdotL) - tmpvar_20));
  mediump vec3 tmpvar_29;
  tmpvar_29 = ((tmpvar_21 * _LightColor0.xyz) * ((tmpvar_28 * atten) * 2.0));
...
void main ()
{
  ...
  NdotL = tmpvar_24;
  lowp float tmpvar_25;
  tmpvar_25 = max (NdotL, (abs (NdotL) - tmpvar_20));
  mediump vec3 tmpvar_26;
  tmpvar_26 = ((tmpvar_21 * _LightColor0.xyz) * ((tmpvar_25 * atten) * 2.0));
  c_i0_i1.xyz = tmpvar_26;
  c_i0_i1.w = tmpvar_20;
  tmpvar_23 = c_i0_i1;
  c = tmpvar_23;
...
Program "fp" {
// Fragment combos: 5
//   opengl - ALU: 45 to 57, TEX: 3 to 5
//   d3d9 - ALU: 48 to 60, TEX: 3 to 5
SubProgram "opengl " {
Keywords { "POINT" }
Vector 0 [_LightColor0]
Vector 1 [_Color]
...
pow_pp r2.x, r0.x, c4.x
mov_pp r0.x, r2.x
mad_pp r2.x, -r0, c5, r0.z
mul_pp r0.x, r0, c3
mad_pp_sat r0.x, r0, c6.w, r6
mul_pp r4.xyz, r4, r0.x
dp3_pp r6.x, t4, t4
dp3_pp r4.x, r4, c7
mul_pp r4.x, r4, r4
rsq_pp r6.x, r6.x
mul_pp r6.xyz, r6.x, t4
add_pp r0.x, -r0, c6.z
mul_pp r0.xyz, r5, r0.x
mad_pp_sat r2.x, r5.w, r2, r4
dp3_pp r1.x, r1, r6
abs_pp r4.x, r1
add_pp r2.x, r4, -r2
max_pp r1.x, r1, r2
...
MAD R5.xy, fragment.texcoord[5], R1.w, c[7].w;
MUL R0.x, R3.y, R3.y;
MAD R0.x, -R3, R3, -R0;
ADD R0.x, R0, c[6].z;
RSQ R0.x, R0.x;
...
MUL R0.xyz, R0, R1.y;
DP3 R3.w, R0, c[7];
MUL R0.xyz, R1.z, fragment.texcoord[4];
DP3 R0.x, R3, R0;
MUL R1.z, R3.w, R3.w;
MUL R2, R2, c[1];
MAD_SAT R0.z, R2.w, R1.x, R1;
ABS R0.y, R0.x;
ADD R0.y, R0, -R0.z;
ADD R0.z, -R1.y, c[6];
MAX R0.x, R0, R0.y;
...
DP3 R1.y, R1, c[7];
MUL R0, R0, c[1];
MAD R1.x, -R2.z, c[5], R2.y;
ADD R1.z, -R2.x, c[6];
MUL R1.y, R1, R1;
MAD_SAT R1.y, R0.w, R1.x, R1;
DP3 R0.w, R3, fragment.texcoord[4];
ABS R1.x, R0.w;
MUL R2.xyz, R0, R1.z;
ADD R1.x, R1, -R1.y;
