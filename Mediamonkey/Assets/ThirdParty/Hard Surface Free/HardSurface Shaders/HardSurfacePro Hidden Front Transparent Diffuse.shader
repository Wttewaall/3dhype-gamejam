...
void main ()
{
  ...
  xlat_mutable__Color = (_Color * texture2D (_MainTex, xlv_TEXCOORD0));
  mediump vec3 tmpvar_10;
  tmpvar_10.x = dot (tmpvar_2, vec3(0.0, 0.0, 1.0));
  tmpvar_10.y = dot (tmpvar_3, vec3(0.0, 0.0, 1.0));
  tmpvar_10.z = dot (tmpvar_4, vec3(0.0, 0.0, 1.0));
  highp vec3 tmpvar_11;
  tmpvar_11 = normalize (reflect (tmpvar_1, tmpvar_10));
  worldRefl = tmpvar_11;
  mediump vec3 tmpvar_12;
  tmpvar_12.x = dot (tmpvar_2, vec3(0.0, 0.0, 1.0));
  tmpvar_12.y = dot (tmpvar_3, vec3(0.0, 0.0, 1.0));
  tmpvar_12.z = dot (tmpvar_4, vec3(0.0, 0.0, 1.0));
  mediump float tmpvar_13;
  tmpvar_13 = abs (dot (worldRefl, tmpvar_12));
  SurfAngle = tmpvar_13;
  lowp float tmpvar_14;
  tmpvar_14 = pow ((1.0 - SurfAngle), _FrezFalloff);
  xlat_mutable__Color.w = (xlat_mutable__Color.w * (1.0 - (tmpvar_14 * _EdgeAlpha)));
  lowp float tmpvar_15;
  tmpvar_15 = (tmpvar_14 * (_FrezPow * 0.000976563));
  lowp vec4 tmpvar_16;
  tmpvar_16 = textureCube (_Cube, worldRefl);
  CubeTex = tmpvar_16;
  float tmpvar_17;
  tmpvar_17 = clamp ((_Reflection + tmpvar_15), 0.0, 1.0);
  CubeTex.xyz = (tmpvar_16.xyz * tmpvar_17);
  lowp float tmpvar_18;
  tmpvar_18 = dot (CubeTex.xyz, vec3(0.22, 0.707, 0.071));
  lowp float tmpvar_19;
  tmpvar_19 = (tmpvar_18 * tmpvar_18);
  tmpvar_9 = _Shininess;
  float tmpvar_20;
  tmpvar_20 = clamp ((xlat_mutable__Color.w + tmpvar_19), 0.0, 1.0);
  lowp vec3 tmpvar_21;
  tmpvar_21 = (xlat_mutable__Color.xyz * (1.0 - tmpvar_17));
  ...
  tmpvar_24 = max (tmpvar_23, (abs (tmpvar_23) - tmpvar_20));
  ...
  tmpvar_27 = (pow (tmpvar_26, (tmpvar_9 * 128.0)) * clamp ((_Gloss + tmpvar_15), 0.0, 1.0));
  mediump vec3 tmpvar_28;
  tmpvar_28 = ((((tmpvar_21 * _LightColor0.xyz) * tmpvar_24) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_27)) * 2.0);
  c_i0_i1.xyz = tmpvar_28;
  c_i0_i1.w = clamp ((tmpvar_20 + ((_LightColor0.w * _SpecColor.w) * tmpvar_27)), 0.0, 1.0);
  c = c_i0_i1;
  c.xyz = (c_i0_i1.xyz + (tmpvar_21 * xlv_TEXCOORD6));
  c.xyz = (c.xyz + mix (CubeTex.xyz, (CubeTex.xyz * mix (xlat_mutable__Color.xyz, vec3(1.0, 1.0, 1.0), vec3(tmpvar_19))), vec3(_Metalics)));
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  tmpvar_12 = abs (dot (worldRefl, tmpvar_11));
  SurfAngle = tmpvar_12;
  lowp float tmpvar_13;
  tmpvar_13 = pow ((1.0 - SurfAngle), _FrezFalloff);
  xlat_mutable__Color.w = (xlat_mutable__Color.w * (1.0 - (tmpvar_13 * _EdgeAlpha)));
  lowp vec4 tmpvar_14;
  tmpvar_14 = textureCube (_Cube, worldRefl);
  CubeTex = tmpvar_14;
  float tmpvar_15;
  tmpvar_15 = clamp ((_Reflection + (tmpvar_13 * (_FrezPow * 0.000976563))), 0.0, 1.0);
  CubeTex.xyz = (tmpvar_14.xyz * tmpvar_15);
  lowp float tmpvar_16;
  tmpvar_16 = dot (CubeTex.xyz, vec3(0.22, 0.707, 0.071));
  lowp float tmpvar_17;
  tmpvar_17 = (tmpvar_16 * tmpvar_16);
  c = vec4(0.0, 0.0, 0.0, 0.0);
  c.xyz = ((xlat_mutable__Color.xyz * (1.0 - tmpvar_15)) * (2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD5).xyz));
  c.w = clamp ((xlat_mutable__Color.w + tmpvar_17), 0.0, 1.0);
  c.xyz = (c.xyz + mix (CubeTex.xyz, (CubeTex.xyz * mix (xlat_mutable__Color.xyz, vec3(1.0, 1.0, 1.0), vec3(tmpvar_17))), vec3(_Metalics)));
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  lowp float tmpvar_25;
  tmpvar_25 = max (tmpvar_24, (abs (tmpvar_24) - tmpvar_20));
  ...
  tmpvar_28 = (pow (tmpvar_27, (tmpvar_9 * 128.0)) * clamp ((_Gloss + tmpvar_15), 0.0, 1.0));
  ...
  c_i0_i1.w = clamp ((tmpvar_20 + (((_LightColor0.w * _SpecColor.w) * tmpvar_28) * tmpvar_22)), 0.0, 1.0);
  c = c_i0_i1;
  c.xyz = (c_i0_i1.xyz + (tmpvar_21 * xlv_TEXCOORD6));
  c.xyz = (c.xyz + mix (CubeTex.xyz, (CubeTex.xyz * mix (xlat_mutable__Color.xyz, vec3(1.0, 1.0, 1.0), vec3(tmpvar_19))), vec3(_Metalics)));
  gl_FragData[0] = c;
...
void main ()
{
  ...
  tmpvar_17 = (tmpvar_16 * tmpvar_16);
  c = vec4(0.0, 0.0, 0.0, 0.0);
  c.xyz = ((xlat_mutable__Color.xyz * (1.0 - tmpvar_15)) * min ((2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD5).xyz), vec3((texture2DProj (_ShadowMapTexture, xlv_TEXCOORD7).x * 2.0))));
  c.w = clamp ((xlat_mutable__Color.w + tmpvar_17), 0.0, 1.0);
  c.xyz = (c.xyz + mix (CubeTex.xyz, (CubeTex.xyz * mix (xlat_mutable__Color.xyz, vec3(1.0, 1.0, 1.0), vec3(tmpvar_17))), vec3(_Metalics)));
  gl_FragData[0] = c;
}
...
Program "fp" {
// Fragment combos: 4
//   opengl - ALU: 38 to 64, TEX: 2 to 4
//   d3d9 - ALU: 41 to 71, TEX: 3 to 5
SubProgram "opengl " {
Keywords { "DIRECTIONAL" "LIGHTMAP_OFF" "SHADOWS_OFF" }
...
MUL R0, R0, c[2];
MUL R3.y, R1.x, R1.x;
ADD R1.xyz, -R0, c[10].y;
MAD R1.xyz, R3.y, R1, R0;
MAD R4.xyz, R2, R1, -R2;
ADD R1.x, -R2.w, c[10].y;
MAD R3.x, -R3, c[8], R3.z;
MUL R0.xyz, R0, R1.x;
MAD_SAT R0.w, R0, R3.x, R3.y;
MUL R3.xyz, R0, fragment.texcoord[6];
ABS R1.y, fragment.texcoord[5].z;
ADD R1.y, R1, -R0.w;
MAX R2.w, fragment.texcoord[5].z, R1.y;
RSQ R3.w, R3.w;
MOV R1.xyz, fragment.texcoord[5];
MAD R1.xyz, R3.w, fragment.texcoord[4], R1;
DP3 R1.x, R1, R1;
RSQ R1.y, R1.x;
MOV R3.w, c[4].x;
MUL R1.y, R1, R1.z;
MOV R1.x, c[11].w;
MUL R1.z, R1.x, c[3].x;
MAX R1.x, R1.y, c[10].w;
MAD_SAT R3.w, R1, c[10].z, R3;
POW R4.w, R1.x, R1.z;
MOV R1, c[1];
MUL R3.w, R4, R3;
MUL R1.xyz, R1, c[0];
...
MAD R1.xyz, R4, c[9].x, R2;
ADD result.color.xyz, R0, R1;
MAD_SAT result.color.w, R3, R1, R0;
END
...
dcl_2d s0
dcl_cube s1
def c10, 2.00000000, 0.00097656, 1.00000000, 6.00000000
...
mov_pp r1.x, c3
abs_pp r0.w, r0
add_pp r2.x, c10.z, -r1
add_pp r0.w, -r0, c10.z
pow_pp r1, r0.w, c7.x
mul_pp r0.w, r2.x, c10
texldl r0.xyz, r0, s1
mov_pp r1.y, c10.z
mul_pp r4.x, r1, c6
mov_pp r0.w, c5.x
mad_pp_sat r3.x, r4, c10.y, r0.w
mul_pp r2.xyz, r3.x, r0
dp3_pp r0.x, r2, c11
mul_pp r2.w, r0.x, r0.x
texld r0, v0, s0
mad_pp r3.y, -r1.x, c8.x, r1
mul_pp r1, r0, c2
dp3_pp r0.w, v4, v4
mad_pp_sat r1.w, r1, r3.y, r2
abs_pp r0.x, v5.z
add_pp r0.x, r0, -r1.w
max_pp r3.w, v5.z, r0.x
rsq_pp r0.w, r0.w
mov_pp r0.xyz, v5
mad_pp r0.xyz, r0.w, v4, r0
dp3_pp r0.x, r0, r0
add_pp r0.w, -r3.x, c10.z
mov_pp r0.y, c3.x
rsq_pp r0.x, r0.x
mul_pp r0.x, r0, r0.z
mul_pp r3.xyz, r1, r0.w
mul_pp r4.z, c12.x, r0.y
max_pp r4.y, r0.x, c11.w
pow_pp r0, r4.y, r4.z
mov_pp r0.y, c4.x
mad_pp_sat r4.x, r4, c10.y, r0.y
mov_pp r0.w, r0.x
mov_pp r0.xyz, c0
mul_pp r0.w, r0, r4.x
mul_pp r0.xyz, c1, r0
...
dcl_cube s1
dcl_2d s2
def c7, 2.00000000, 0.00097656, 1.00000000, 6.00000000
...
mov_pp r0.y, c2.x
mul_pp r1.w, r0.z, c7
mad_pp_sat r3.x, r0, c7.y, r0.y
texldl r0.xyz, r1, s1
mul_pp r0.xyz, r3.x, r0
dp3_pp r2.w, r0, c8
texld r1, v0, s0
mul_pp r1, r1, c0
add_pp r2.xyz, -r1, c7.z
mul_pp r2.w, r2, r2
...
MUL R2.w, R2.z, c[6].x;
MOV R0.w, c[5].x;
MAD_SAT R2.x, R2.w, c[10].z, R0.w;
MUL R0.xyz, R2.x, R0;
DP3 R0.w, R0, c[11];
ADD R2.x, -R2, c[10].y;
MUL R3.xyz, R1, R2.x;
MUL R0.w, R0, R0;
MAD R2.y, -R2.z, c[8].x, R2;
MAD_SAT R1.w, R1, R2.y, R0;
ABS R2.y, fragment.texcoord[5].z;
ADD R2.y, R2, -R1.w;
MAX R4.w, fragment.texcoord[5].z, R2.y;
RSQ R3.w, R3.w;
MOV R2.xyz, fragment.texcoord[5];
MAD R2.xyz, R3.w, fragment.texcoord[4], R2;
DP3 R2.x, R2, R2;
RSQ R2.y, R2.x;
MOV R3.w, c[4].x;
MUL R2.y, R2, R2.z;
MOV R2.x, c[11].w;
MUL R2.z, R2.x, c[3].x;
MAX R2.x, R2.y, c[10].w;
POW R4.x, R2.x, R2.z;
MAD_SAT R3.w, R2, c[10].z, R3;
MOV R2, c[1];
MUL R3.w, R4.x, R3;
MUL R2.xyz, R2, c[0];
MUL R4.xyz, R2, R3.w;
...
abs_pp r0.x, r0
mov_pp r0.y, c3.x
add_pp r1.w, -r0.x, c10.z
add_pp r2.x, c10.z, -r0.y
pow_pp r0, r1.w, c7.x
mul_pp r1.w, r2.x, c10
texldl r1.xyz, r1, s1
mov_pp r1.w, r0.x
mul_pp r3.w, r1, c6.x
mov_pp r0.x, c5
mad_pp_sat r3.x, r3.w, c10.y, r0
mul_pp r2.xyz, r3.x, r1
dp3_pp r0.x, r2, c11
mul_pp r2.w, r0.x, r0.x
mov_pp r1.x, c10.z
texld r0, v0, s0
mad_pp r3.y, -r1.w, c8.x, r1.x
mul_pp r1, r0, c2
dp3_pp r0.w, v4, v4
mad_pp_sat r1.w, r1, r3.y, r2
abs_pp r0.x, v5.z
add_pp r0.x, r0, -r1.w
max_pp r4.w, v5.z, r0.x
rsq_pp r0.w, r0.w
mov_pp r0.xyz, v5
mad_pp r0.xyz, r0.w, v4, r0
dp3_pp r0.x, r0, r0
...
mul_pp r0.x, r0, r0.z
mul_pp r3.xyz, r1, r0.w
mul_pp r4.y, c12.x, r0
max_pp r4.x, r0, c11.w
pow_pp r0, r4.x, r4.y
mov_pp r0.y, c4.x
mad_pp_sat r3.w, r3, c10.y, r0.y
mov_pp r0.w, r0.x
mov_pp r0.xyz, c0
mul_pp r3.w, r0, r3
mul_pp r0.xyz, c1, r0
...
add_pp r0.yzw, -r1.xxyz, c10.z
mad_pp r1.xyz, r2.w, r0.yzww, r1
texldp r0.x, v7, s2
mov_pp r0.y, c0.w
mad_pp r1.xyz, r2, r1, -r2
mul_pp r0.y, c1.w, r0
...
mul_pp r3.xyz, r3, v6
mad_pp r3.xyz, r4, c10.x, r3
mad_pp r1.xyz, r1, c9.x, r2
add_pp oC0.xyz, r3, r1
mad_pp_sat oC0.w, r0.x, r0.y, r1
"
}
...
MAD R0.xyz, R2, R0, -R2;
MAD R2.xyz, R0, c[5].x, R2;
MOV R0.x, c[6].y;
MAD R3.w, -R3.y, c[4].x, R0.x;
ADD R0.y, -R3.x, c[6];
MUL R3.xyz, R1, R0.y;
...
MAD_SAT result.color.w, R1, R3, R2;
END
...
dcl_2d s2
dcl_2d s3
def c7, 2.00000000, 0.00097656, 8.00000000, 1.00000000
...
void main ()
{
  ...
  tmpvar_9 = _Shininess;
  float tmpvar_19;
  tmpvar_19 = clamp ((xlat_mutable__Color.w + (tmpvar_18 * tmpvar_18)), 0.0, 1.0);
  lowp vec3 tmpvar_20;
  tmpvar_20 = (xlat_mutable__Color.xyz * (1.0 - tmpvar_17));
  ...
  lowp float tmpvar_25;
  tmpvar_25 = max (tmpvar_24, (abs (tmpvar_24) - tmpvar_19));
  lowp float tmpvar_26;
  ...
  c_i0_i1.xyz = tmpvar_29;
  c_i0_i1.w = clamp ((tmpvar_19 + (((_LightColor0.w * _SpecColor.w) * tmpvar_28) * atten)), 0.0, 1.0);
  c = c_i0_i1;
  c.w = 0.0;
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  lowp float tmpvar_23;
  tmpvar_23 = max (tmpvar_22, (abs (tmpvar_22) - tmpvar_19));
  lowp float tmpvar_24;
  ...
  nh = tmpvar_25;
  mediump float tmpvar_26;
  tmpvar_26 = (pow (tmpvar_25, (tmpvar_9 * 128.0)) * clamp ((_Gloss + tmpvar_15), 0.0, 1.0));
  mediump vec3 tmpvar_27;
  tmpvar_27 = ((((tmpvar_20 * _LightColor0.xyz) * tmpvar_23) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_26)) * 2.0);
  c_i0_i1.xyz = tmpvar_27;
  c_i0_i1.w = clamp ((tmpvar_19 + ((_LightColor0.w * _SpecColor.w) * tmpvar_26)), 0.0, 1.0);
  c = c_i0_i1;
  c.w = 0.0;
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  c_i0_i1.xyz = tmpvar_27;
  c_i0_i1.w = clamp ((tmpvar_19 + (((_LightColor0.w * _SpecColor.w) * tmpvar_26) * atten)), 0.0, 1.0);
  c = c_i0_i1;
  c.w = 0.0;
  gl_FragData[0] = c;
}
...
Program "fp" {
// Fragment combos: 5
//   opengl - ALU: 54 to 65, TEX: 2 to 4
//   d3d9 - ALU: 60 to 69, TEX: 3 to 5
SubProgram "opengl " {
Keywords { "POINT" }
Vector 0 [_LightColor0]
Vector 1 [_SpecColor]
...
MUL R2.z, R0.y, R0.y;
MAD R2.y, -R0.w, c[8].x, R0.x;
TEX R0, fragment.texcoord[0], texture[0], 2D;
MUL R0, R0, c[2];
MAD_SAT R2.y, R0.w, R2, R2.z;
ABS R0.w, R1.z;
ADD R0.w, R0, -R2.y;
ADD R2.y, -R2.x, c[9].z;
...
mul_pp r2.z, r0, r0
mad_pp r2.x, -r0, c8, r0.y
texld r0, v0, s0
mul_pp r0, r0, c2
mad_pp_sat r2.x, r0.w, r2, r2.z
abs_pp r0.w, r1.z
add_pp r0.w, r0, -r2.x
max_pp r2.x, r1.z, r0.w
add_pp r0.w, -r2.y, c9.z
dp3_pp r2.z, v5, v5
rsq_pp r2.z, r2.z
mul_pp r0.xyz, r0, r0.w
mad_pp r2.yzw, r2.z, v5.xxyz, r1.xxyz
mul_pp r1.xyz, r0, c0
...
MUL R1.w, R1.z, c[6].x;
MOV R0.w, c[5].x;
MAD_SAT R1.x, R1.w, c[9].w, R0.w;
MUL R0.xyz, R1.x, R0;
DP3 R0.x, R0, c[10];
MUL R1.y, R0.x, R0.x;
MOV R2.x, c[9].z;
MAD R1.z, -R1, c[8].x, R2.x;
TEX R0, fragment.texcoord[0], texture[0], 2D;
MUL R0, R0, c[2];
MAD_SAT R1.y, R0.w, R1.z, R1;
...
mul_pp r1.w, r0.x, c6.x
mov_pp r0.y, c5.x
mad_pp_sat r0.w, r1, c9.y, r0.y
mul_pp r1.xyz, r0.w, r1
dp3_pp r0.y, r1, c10
mov_pp r0.z, c9
dp3_pp r1.x, v5, v5
mad_pp r0.x, -r0, c8, r0.z
mul_pp r0.y, r0, r0
mad_pp_sat r0.y, r2.w, r0.x, r0
abs_pp r0.x, v4.z
add_pp r0.x, r0, -r0.y
...
MUL R1.w, R0, c[6].x;
MOV R1.x, c[5];
MAD_SAT R2.x, R1.w, c[10], R1;
MUL R0.xyz, R2.x, R0;
DP3 R0.y, R0, c[10].yzww;
MOV R0.x, c[9].w;
DP3 R1.x, fragment.texcoord[4], fragment.texcoord[4];
RSQ R1.x, R1.x;
MUL R1.xyz, R1.x, fragment.texcoord[4];
...
def c10, 0.00097656, 6.00000000, 128.00000000, 0
...
add_pp r2.x, c9.y, -r0.y
pow_pp r0, r1.w, c7.x
mul_pp r1.w, r2.x, c10.y
texldl r1.xyz, r1, s1
mul_pp r1.w, r0.x, c6.x
mov_pp r0.y, c5.x
mad_pp_sat r2.x, r1.w, c10, r0.y
...
mul_pp r1.xyz, r1.x, v4
mul_pp r2.z, r0, r0
mad_pp r2.y, -r0.x, c8.x, r0
texld r0, v0, s0
mul_pp r0, r0, c2
mad_pp_sat r2.y, r0.w, r2, r2.z
abs_pp r0.w, r1.z
add_pp r0.w, r0, -r2.y
max_pp r2.w, r1.z, r0
add_pp r0.w, -r2.x, c9.y
dp3_pp r2.y, v5, v5
rsq_pp r2.y, r2.y
mul_pp r0.xyz, r0, r0.w
mad_pp r2.xyz, r2.y, v5, r1
mul_pp r1.xyz, r0, c0
dp3_pp r0.w, r2, r2
rsq_pp r0.x, r0.w
mov_pp r0.y, c3.x
mul_pp r0.x, r0, r2.z
mul_pp r2.y, c10.z, r0
max_pp r2.x, r0, c9
pow_pp r0, r2.x, r2.y
mov_pp r0.y, c4.x
mad_pp_sat r1.w, r1, c10.x, r0.y
mov_pp r0.w, r0.x
mov_pp r0.xyz, c0
mul_pp r0.w, r0, r1
mul_pp r0.xyz, c1, r0
...
mul_pp r1.w, r0, c6.x
mov_pp r1.x, c5
mad_pp_sat r2.x, r1.w, c9.y, r1
mul_pp r0.xyz, r2.x, r0
dp3_pp r0.x, r0, c10
mov_pp r0.y, c9.z
dp3_pp r1.x, v4, v4
rsq_pp r1.x, r1.x
mad_pp r2.z, -r0.w, c8.x, r0.y
mul_pp r2.y, r0.x, r0.x
texld r0, v0, s0
mul_pp r0, r0, c2
mad_pp_sat r2.y, r0.w, r2.z, r2
mul_pp r1.xyz, r1.x, v4
abs_pp r2.z, r1
add_pp r2.x, -r2, c9.z
...
dp3_pp r0.w, v5, v5
rsq_pp r2.y, r0.w
max_pp r0.w, r1.z, r2.z
mad_pp r1.xyz, r2.y, v5, r1
dp3_pp r1.x, r1, r1
rsq_pp r1.y, r1.x
mul_pp r1.y, r1, r1.z
mov_pp r1.x, c3
mul_pp r0.xyz, r0, c0
mul_pp r1.x, c11, r1
max_pp r1.y, r1, c10.w
pow_pp r2, r1.y, r1.x
mov_pp r1.x, c4
mad_pp_sat r1.w, r1, c9.y, r1.x
mov_pp r1.xyz, c0
mul_pp r1.w, r2.x, r1
mul_pp r1.xyz, c1, r1
...
void main ()
{
  ...
  tmpvar_17 = (tmpvar_16 * tmpvar_16);
  float tmpvar_18;
  tmpvar_18 = clamp ((xlat_mutable__Color.w + tmpvar_17), 0.0, 1.0);
  lowp vec3 tmpvar_19;
  tmpvar_19 = (xlat_mutable__Color.xyz * (1.0 - tmpvar_15));
  ...
  NdotL = tmpvar_21;
  lowp float tmpvar_22;
  tmpvar_22 = max (NdotL, (abs (NdotL) - tmpvar_18));
  mediump vec3 tmpvar_23;
  ...
  tmpvar_20 = c_i0_i1;
  c = tmpvar_20;
  c.xyz = (c.xyz + (tmpvar_19 * xlv_TEXCOORD5));
  c.xyz = (c.xyz + mix (CubeTex.xyz, (CubeTex.xyz * mix (xlat_mutable__Color.xyz, vec3(1.0, 1.0, 1.0), vec3(tmpvar_17))), vec3(_Metalics)));
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  tmpvar_17 = (tmpvar_16 * tmpvar_16);
  c = vec4(0.0, 0.0, 0.0, 0.0);
  c.xyz = ((xlat_mutable__Color.xyz * (1.0 - tmpvar_15)) * (2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD4).xyz));
  c.w = clamp ((xlat_mutable__Color.w + tmpvar_17), 0.0, 1.0);
  c.xyz = (c.xyz + mix (CubeTex.xyz, (CubeTex.xyz * mix (xlat_mutable__Color.xyz, vec3(1.0, 1.0, 1.0), vec3(tmpvar_17))), vec3(_Metalics)));
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  NdotL = tmpvar_22;
  lowp float tmpvar_23;
  tmpvar_23 = max (NdotL, (abs (NdotL) - tmpvar_18));
  mediump vec3 tmpvar_24;
...
void main ()
{
  ...
  tmpvar_17 = (tmpvar_16 * tmpvar_16);
  c = vec4(0.0, 0.0, 0.0, 0.0);
  c.xyz = ((xlat_mutable__Color.xyz * (1.0 - tmpvar_15)) * min ((2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD4).xyz), vec3((texture2DProj (_ShadowMapTexture, xlv_TEXCOORD6).x * 2.0))));
  c.w = clamp ((xlat_mutable__Color.w + tmpvar_17), 0.0, 1.0);
  c.xyz = (c.xyz + mix (CubeTex.xyz, (CubeTex.xyz * mix (xlat_mutable__Color.xyz, vec3(1.0, 1.0, 1.0), vec3(tmpvar_17))), vec3(_Metalics)));
  gl_FragData[0] = c;
}
...
Program "fp" {
// Fragment combos: 4
//   opengl - ALU: 38 to 45, TEX: 2 to 4
//   d3d9 - ALU: 38 to 45, TEX: 2 to 4
SubProgram "opengl " {
Keywords { "DIRECTIONAL" "LIGHTMAP_OFF" "SHADOWS_OFF" }
Vector 0 [_LightColor0]
Vector 1 [_Color]
...
dcl_2d s0
dcl_cube s1
def c7, 2.00000000, 1.00000000, 0.00097656, 0
...
mul_pp r0.x, r1.x, c3
mad_pp_sat r0.x, r0, c7.z, r4
mul_pp r4.xyz, r3, r0.x
mul_pp r3, r2, c1
dp3_pp r2.x, r4, c8
mul_pp r2.x, r2, r2
mad_pp r1.x, -r1.x, c5, r0.y
mad_pp_sat r1.x, r3.w, r1, r2
add_pp r5.xyz, -r3, c7.y
mad_pp r5.xyz, r2.x, r5, r3
add_pp r2.x, -r0, c7.y
mul_pp r2.xyz, r3, r2.x
mul_pp r3.xyz, r2, c0
mad_pp r5.xyz, r4, r5, -r4
abs_pp r0.x, t4.z
add_pp r0.x, r0, -r1
max_pp r0.x, t4.z, r0
...
MUL R0.xyz, R0, R1;
MAD result.color.xyz, R0, c[6].w, R2;
MAD_SAT result.color.w, R1, R2, R4.x;
END
...
dcl_cube s1
dcl_2d s2
def c6, 2.00000000, 0.00097656, 8.00000000, 1.00000000
...
mul_pp r2.x, r2, r2
mad_pp_sat r0.w, r4, r1.x, r2.x
add_pp r6.xyz, -r4, c6.w
mad_pp r6.xyz, r2.x, r6, r4
mad_pp r6.xyz, r5, r6, -r5
mad_pp r5.xyz, r6, c5.x, r5
mul_pp r0.xyz, r4, r0.x
mul_pp r1.xyz, r3.w, r3
mul_pp r0.xyz, r1, r0
mad_pp r0.xyz, r0, c6.z, r5
mov_pp oC0, r0
"
}
...
ADD R2.xyz, -R0, c[7].y;
MUL R3.y, R3, R3;
MAD R2.xyz, R3.y, R2, R0;
MAD R2.xyz, R1, R2, -R1;
MAD R1.xyz, R2, c[6].x, R1;
ADD R1.w, -R1, c[7].y;
MAD R2.w, -R2, c[5].x, R3.z;
MAD_SAT R0.w, R0, R2, R3.y;
ABS R2.x, fragment.texcoord[4].z;
ADD R2.x, R2, -R0.w;
MUL R0.xyz, R0, R1.w;
...
TEX R1, fragment.texcoord[0], texture[0], 2D;
MUL R0.xyz, R0.w, R0;
MAD_SAT R4.y, R2, c[6].z, R2.x;
MUL R2.xyz, R4.y, R3;
MUL R1, R1, c[0];
DP3 R2.w, R2, c[7];
ADD R3.xyz, -R1, c[6].y;
MUL R2.w, R2, R2;
MAD R3.xyz, R2.w, R3, R1;
MAD R3.xyz, R2, R3, -R2;
MAD R2.xyz, R3, c[5].x, R2;
MOV R3.x, c[6].y;
ADD R3.y, -R4, c[6];
MAD R3.x, -R3.w, c[4], R3;
MUL R1.xyz, R1, R3.y;
MUL R0.w, R4.x, c[6].x;
MUL R0.xyz, R0, c[6].w;
MIN R0.xyz, R0, R0.w;
MAD result.color.xyz, R1, R0, R2;
MAD_SAT result.color.w, R1, R3.x, R2;
END
...
mul_pp r2.x, r2, r2
mad_pp_sat r0.w, r6, r0.x, r2.x
add_pp r7.xyz, -r6, c6.w
mad_pp r7.xyz, r2.x, r7, r6
...
void main ()
{
  ...
  tmpvar_16 = dot (CubeTex.xyz, vec3(0.22, 0.707, 0.071));
  float tmpvar_17;
  tmpvar_17 = clamp ((xlat_mutable__Color.w + (tmpvar_16 * tmpvar_16)), 0.0, 1.0);
  lowp vec3 tmpvar_18;
  tmpvar_18 = (xlat_mutable__Color.xyz * (1.0 - tmpvar_15));
  mediump vec3 tmpvar_19;
  tmpvar_19 = normalize (xlv_TEXCOORD4);
  lightDir = tmpvar_19;
  highp vec2 tmpvar_20;
  tmpvar_20 = vec2(dot (xlv_TEXCOORD5, xlv_TEXCOORD5));
  lowp vec4 tmpvar_21;
  ...
  NdotL = tmpvar_23;
  lowp float tmpvar_24;
  tmpvar_24 = max (NdotL, (abs (NdotL) - tmpvar_17));
  mediump vec3 tmpvar_25;
...
void main ()
{
  ...
  tmpvar_21 = max (NdotL, (abs (NdotL) - tmpvar_17));
  mediump vec3 tmpvar_22;
...
void main ()
{
  ...
  lightDir = tmpvar_19;
  lowp float tmpvar_20;
  tmpvar_20 = texture2D (_LightTexture0, ((xlv_TEXCOORD5.xy / xlv_TEXCOORD5.w) + 0.5)).w;
  lowp float tmpvar_21;
  highp vec3 LightCoord_i0;
  ...
  lightDir_i0 = lightDir;
  mediump float atten;
  atten = ((float((xlv_TEXCOORD5.z > 0.0)) * tmpvar_20) * tmpvar_21);
  lowp vec4 c_i0_i1;
  lowp float NdotL;
  ...
  NdotL = tmpvar_24;
  lowp float tmpvar_25;
  tmpvar_25 = max (NdotL, (abs (NdotL) - tmpvar_17));
...
void main ()
{
  ...
  lightDir = xlv_TEXCOORD4;
  lowp vec4 tmpvar_19;
  tmpvar_19 = texture2D (_LightTexture0, xlv_TEXCOORD5);
  mediump vec4 tmpvar_20;
  mediump vec3 lightDir_i0;
  lightDir_i0 = lightDir;
  mediump float atten;
  ...
  NdotL = tmpvar_21;
  lowp float tmpvar_22;
  tmpvar_22 = max (NdotL, (abs (NdotL) - tmpvar_17));
  mediump vec3 tmpvar_23;
...
Program "fp" {
// Fragment combos: 5
//   opengl - ALU: 37 to 49, TEX: 2 to 4
//   d3d9 - ALU: 39 to 49, TEX: 2 to 4
SubProgram "opengl " {
Keywords { "POINT" }
Vector 0 [_LightColor0]
Vector 1 [_Color]
...
MUL R1.z, R1.y, R1.y;
MOV R1.x, c[6].z;
MAD R1.y, -R2, c[5].x, R1.x;
MAD_SAT R1.y, R0.w, R1, R1.z;
ADD R1.z, -R2.x, c[6];
DP3 R1.x, fragment.texcoord[4], fragment.texcoord[4];
RSQ R1.x, R1.x;
MUL R0.w, R1.x, fragment.texcoord[4].z;
ABS R1.x, R0.w;
MUL R2.xyz, R0, R1.z;
ADD R1.x, R1, -R1.y;
MAX R0.x, R0.w, R1;
...
MOV R1.x, c[6].z;
MUL R0, R0, c[1];
MAD R1.x, -R1.w, c[5], R1;
MAD_SAT R0.w, R0, R1.x, R1.y;
ADD R1.z, -R2.x, c[6];
MUL R1.xyz, R0, R1.z;
...
mov_pp r0.x, r1.x
mul_pp r1.x, r0, c3
mad_pp r0.x, -r0, c5, r0.y
mad_pp_sat r1.x, r1, c6.z, r4
mul_pp r2.xyz, r2, r1.x
dp3_pp r2.x, r2, c7
mul_pp r2.x, r2, r2
mad_pp_sat r0.x, r3.w, r0, r2
add_pp r1.x, -r1, c6.y
mul_pp r2.xyz, r3, r1.x
abs_pp r1.x, t4.z
add_pp r0.x, r1, -r0
mul_pp r1.xyz, r2, c0
max_pp r0.x, t4.z, r0
...
MAD R4.xy, fragment.texcoord[5], R1.w, c[7].w;
DP3 R1.w, fragment.texcoord[5], fragment.texcoord[5];
MOV R1.y, fragment.texcoord[2].z;
MOV R1.z, fragment.texcoord[3];
MOV R1.x, fragment.texcoord[1].z;
...
DP3 R0.x, R0, c[7];
MOV R0.y, c[6].z;
MAD R1.y, -R1, c[5].x, R0;
DP3 R0.z, fragment.texcoord[4], fragment.texcoord[4];
RSQ R0.y, R0.z;
MUL R2, R2, c[1];
MUL R0.x, R0, R0;
MAD_SAT R0.z, R2.w, R1.y, R0.x;
MUL R0.y, R0, fragment.texcoord[4].z;
ABS R0.x, R0.y;
ADD R0.x, R0, -R0.z;
ADD R0.z, -R1.x, c[6];
MAX R1.x, R0.y, R0;
