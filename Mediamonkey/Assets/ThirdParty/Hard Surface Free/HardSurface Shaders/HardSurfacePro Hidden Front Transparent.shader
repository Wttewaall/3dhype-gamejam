...
void main ()
{
  ...
  xlat_mutable__Color.w = (_Color.w * (1.0 - (tmpvar_14 * _EdgeAlpha)));
  ...
  c = c_i0_i1;
  c.xyz = (c_i0_i1.xyz + (tmpvar_21 * xlv_TEXCOORD5));
...
void main ()
{
  ...
  xlat_mutable__Color.w = (_Color.w * (1.0 - (tmpvar_13 * _EdgeAlpha)));
  lowp vec4 tmpvar_14;
...
void main ()
{
  ...
  mediump float nh;
  lowp float tmpvar_24;
  tmpvar_24 = dot (vec3(0.0, 0.0, 1.0), xlv_TEXCOORD4);
  lowp float tmpvar_25;
  tmpvar_25 = max (tmpvar_24, (abs (tmpvar_24) - tmpvar_20));
  lowp float tmpvar_26;
  tmpvar_26 = dot (vec3(0.0, 0.0, 1.0), normalize ((xlv_TEXCOORD4 + viewDir)));
  nh = tmpvar_26;
  mediump float tmpvar_27;
...
Program "fp" {
// Fragment combos: 4
//   opengl - ALU: 36 to 62, TEX: 1 to 3
//   d3d9 - ALU: 41 to 70, TEX: 2 to 4
SubProgram "opengl " {
Keywords { "DIRECTIONAL" "LIGHTMAP_OFF" "SHADOWS_OFF" }
...
MUL R1.w, R1.y, c[6].x;
MOV R0.w, c[5].x;
MAD_SAT R1.x, R1.w, c[10].z, R0.w;
MUL R2.xyz, R1.x, R0;
MOV R0.w, c[10].y;
ADD R0.xyz, R0.w, -c[2];
DP3 R1.z, R2, c[11];
MUL R1.z, R1, R1;
MAD R0.xyz, R1.z, R0, c[2];
MAD R4.xyz, R2, R0, -R2;
MAD R0.w, -R1.y, c[8].x, R0;
MAD_SAT R0.w, R0, c[2], R1.z;
ADD R0.x, -R1, c[10].y;
ABS R0.y, fragment.texcoord[4].z;
ADD R1.x, R0.y, -R0.w;
MUL R0.xyz, R0.x, c[2];
MAX R2.w, fragment.texcoord[4].z, R1.x;
MUL R3.xyz, R0, fragment.texcoord[5];
RSQ R3.w, R3.w;
MOV R1.xyz, fragment.texcoord[4];
MAD R1.xyz, R3.w, fragment.texcoord[3], R1;
DP3 R1.x, R1, R1;
RSQ R1.y, R1.x;
MOV R3.w, c[4].x;
MUL R1.y, R1, R1.z;
...
mul_pp r1.xyz, r1, v5
mov_pp r4.xyz, c2
add_pp r2.xyz, c10.z, -r4
mad_pp r2.xyz, r1.w, r2, c2
mad_pp r0.xyz, r0, c10.x, r1
mad_pp r1.xyz, r3, r2, -r3
mov_pp r1.w, c0
mad_pp r1.xyz, r1, c9.x, r3
mul_pp r1.w, c1, r1
add_pp oC0.xyz, r0, r1
mad_pp_sat oC0.w, r0, r1, r2
"
}
...
MUL R1.x, R2, c[2];
MOV R0.w, c[1].x;
MAD_SAT R1.w, R1.x, c[6].z, R0;
MUL R0.xyz, R1.w, R0;
MAD R2.w, -R2.x, c[4].x, R2.y;
DP3 R0.w, R0, c[7];
MUL R0.w, R0, R0;
ADD R1.xyz, R2.y, -c[0];
ADD R2.x, -R1.w, c[6].y;
...
MAD_SAT result.color.w, R2, c[0], R0;
END
...
mul_pp r1.x, r2, c3
mov_pp r0.w, c2.x
mad_pp_sat r1.w, r1.x, c7.y, r0
mul_pp r0.xyz, r1.w, r0
mad_pp r2.w, -r2.x, c5.x, r2.y
dp3_pp r0.w, r0, c8
mul_pp r0.w, r0, r0
add_pp r2.x, -r1.w, c7.z
mov_pp r1.xyz, c0
add_pp r1.xyz, c7.z, -r1
...
mul_pp r1.xyz, r1, r2
mad_pp oC0.xyz, r1, c8.w, r0
mad_pp_sat oC0.w, r2, c0, r0
"
}
...
MUL R1.w, R0, c[6].x;
MOV R1.x, c[5];
MAD_SAT R1.x, R1.w, c[10].z, R1;
MUL R2.xyz, R1.x, R0;
DP3 R0.x, R2, c[11];
MUL R3.w, R0.x, R0.x;
MOV R4.y, c[10];
MAD R0.x, -R0.w, c[8], R4.y;
MAD_SAT R0.w, R0.x, c[2], R3;
ABS R0.x, fragment.texcoord[4].z;
ADD R0.y, R0.x, -R0.w;
ADD R0.x, -R1, c[10].y;
MAX R4.x, fragment.texcoord[4].z, R0.y;
MUL R0.xyz, R0.x, c[2];
RSQ R2.w, R2.w;
MOV R1.xyz, fragment.texcoord[4];
MAD R1.xyz, R2.w, fragment.texcoord[3], R1;
DP3 R1.x, R1, R1;
RSQ R1.y, R1.x;
MOV R2.w, c[4].x;
MUL R1.y, R1, R1.z;
...
TXP R4.x, fragment.texcoord[6], texture[1], 2D;
ADD R3.xyz, R4.y, -c[2];
MUL R1.w, R1, c[0];
MUL R1.w, R2, R1;
MUL R1.xyz, R4.x, R1;
...
MAD R3.xyz, R3.w, R3, c[2];
MAD R1.xyz, R2, R3, -R2;
MAD R1.xyz, R1, c[9].x, R2;
ADD result.color.xyz, R0, R1;
MAD_SAT result.color.w, R4.x, R1, R0;
END
...
mul_pp r3.x, r0, c6
mov_pp r0.y, c5.x
mad_pp_sat r0.w, r3.x, c10.y, r0.y
...
mul_pp r0.x, r0, r0.z
mul_pp r1.xyz, r0.w, c2
mul_pp r3.y, c12.x, r0
max_pp r3.z, r0.x, c11.w
pow_pp r0, r3.z, r3.y
mov_pp r0.y, c4.x
mad_pp_sat r3.x, r3, c10.y, r0.y
mov_pp r0.w, r0.x
mov_pp r0.xyz, c0
mul_pp r0.w, r0, r3.x
mul_pp r0.xyz, c1, r0
...
MAD_SAT result.color.w, R2, c[0], R1;
END
...
mul_pp r0.x, r0.w, c3
mov_pp r0.y, c2.x
mad_pp_sat r2.w, r0.x, c7.y, r0.y
mul_pp r0.xyz, r2.w, r1
dp3_pp r1.w, r0, c8.yzww
mov_pp r1.xyz, c0
mul_pp r1.w, r1, r1
add_pp r1.xyz, c7.w, -r1
mad_pp r1.xyz, r1.w, r1, c0
mad_pp r1.xyz, r0, r1, -r0
mad_pp r2.xyz, r1, c6.x, r0
add_pp r0.x, -r2.w, c7.w
mov_pp r0.y, c7.w
mad_pp r2.w, -r0, c5.x, r0.y
...
void main ()
{
  ...
  tmpvar_23 = vec2(dot (xlv_TEXCOORD5, xlv_TEXCOORD5));
  lowp vec3 viewDir;
  viewDir = tmpvar_22;
  lowp float atten;
...
void main ()
{
  ...
  viewDir = tmpvar_22;
  lowp float atten;
  atten = ((float((xlv_TEXCOORD5.z > 0.0)) * texture2D (_LightTexture0, ((xlv_TEXCOORD5.xy / xlv_TEXCOORD5.w) + 0.5)).w) * texture2D (_LightTextureB0, tmpvar_23).w);
  lowp vec4 c_i0_i1;
  mediump float nh;
  lowp float tmpvar_24;
  tmpvar_24 = dot (vec3(0.0, 0.0, 1.0), lightDir);
...
void main ()
{
  ...
  viewDir = tmpvar_22;
  lowp float atten;
  atten = (texture2D (_LightTextureB0, tmpvar_23).w * textureCube (_LightTexture0, xlv_TEXCOORD5).w);
  lowp vec4 c_i0_i1;
  mediump float nh;
  lowp float tmpvar_24;
  tmpvar_24 = dot (vec3(0.0, 0.0, 1.0), lightDir);
...
Program "fp" {
// Fragment combos: 5
//   opengl - ALU: 52 to 63, TEX: 1 to 3
//   d3d9 - ALU: 59 to 68, TEX: 2 to 4
SubProgram "opengl " {
Keywords { "POINT" }
Vector 0 [_LightColor0]
Vector 1 [_SpecColor]
...
MUL R1.w, R1.x, c[6].x;
MOV R0.w, c[5].x;
MAD_SAT R0.w, R1, c[9], R0;
MUL R0.xyz, R0.w, R0;
DP3 R0.y, R0, c[10];
MOV R0.x, c[9].z;
MAD R0.x, -R1, c[8], R0;
MUL R0.y, R0, R0;
MAD_SAT R0.y, R0.x, c[2].w, R0;
...
void main ()
{
  ...
  tmpvar_17 = (tmpvar_16 * tmpvar_16);
  c = vec4(0.0, 0.0, 0.0, 0.0);
  c.xyz = ((xlat_mutable__Color.xyz * (1.0 - tmpvar_15)) * (2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD3).xyz));
  c.w = clamp ((xlat_mutable__Color.w + tmpvar_17), 0.0, 1.0);
  c.xyz = (c.xyz + mix (CubeTex.xyz, (CubeTex.xyz * mix (xlat_mutable__Color.xyz, vec3(1.0, 1.0, 1.0), vec3(tmpvar_17))), vec3(_Metalics)));
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  tmpvar_17 = (tmpvar_16 * tmpvar_16);
  c = vec4(0.0, 0.0, 0.0, 0.0);
  c.xyz = ((xlat_mutable__Color.xyz * (1.0 - tmpvar_15)) * min ((2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD3).xyz), vec3((texture2DProj (_ShadowMapTexture, xlv_TEXCOORD5).x * 2.0))));
  c.w = clamp ((xlat_mutable__Color.w + tmpvar_17), 0.0, 1.0);
  c.xyz = (c.xyz + mix (CubeTex.xyz, (CubeTex.xyz * mix (xlat_mutable__Color.xyz, vec3(1.0, 1.0, 1.0), vec3(tmpvar_17))), vec3(_Metalics)));
  gl_FragData[0] = c;
}
...
Program "fp" {
// Fragment combos: 4
//   opengl - ALU: 36 to 43, TEX: 1 to 3
//   d3d9 - ALU: 38 to 45, TEX: 1 to 3
SubProgram "opengl " {
Keywords { "DIRECTIONAL" "LIGHTMAP_OFF" "SHADOWS_OFF" }
Vector 0 [_LightColor0]
Vector 1 [_Color]
...
MUL R0.x, R0.y, c[3];
MOV R0.z, c[2].x;
MAD_SAT R0.x, R0, c[7].z, R0.z;
MAD R0.y, -R0, c[5].x, R0.w;
TEX R1.xyz, R2, texture[0], CUBE;
MUL R1.xyz, R1, R0.x;
DP3 R0.z, R1, c[8];
MUL R0.z, R0, R0;
ADD R2.xyz, R0.w, -c[1];
MAD_SAT R0.w, R0.y, c[1], R0.z;
ADD R0.y, -R0.x, c[7];
MAD R2.xyz, R0.z, R2, c[1];
MAD R2.xyz, R1, R2, -R1;
...
mov_pp r3.x, c2
mov_pp r0.y, c7
add_pp r4.xyz, c7.y, -r4
texld r2, r1, s0
pow_pp r1.x, r0.x, c4.x
mul_pp r0.x, r1.x, c3
mad_pp_sat r0.x, r0, c7.z, r3
mul_pp r3.xyz, r2, r0.x
dp3_pp r2.x, r3, c8
mul_pp r2.x, r2, r2
mad_pp r1.x, -r1.x, c5, r0.y
mad_pp_sat r1.x, r1, c1.w, r2
...
MUL R3.x, R3, R3;
ADD R2.xyz, R3.y, -c[0];
MAD R2.xyz, R3.x, R2, c[0];
MAD R2.xyz, R1, R2, -R1;
MAD R1.xyz, R2, c[5].x, R1;
ADD R2.x, -R2.w, c[6].y;
MAD R1.w, -R1, c[4].x, R3.y;
MUL R2.xyz, R2.x, c[0];
MUL R0.xyz, R0.w, R0;
MUL R0.xyz, R0, R2;
MAD result.color.xyz, R0, c[6].w, R1;
MAD_SAT result.color.w, R1, c[0], R3.x;
END
...
dcl_cube s0
dcl_2d s1
def c6, 2.00000000, 0.00097656, 1.00000000, 8.00000000
...
mov_pp r4.x, c1
mov_pp r0.z, c6
add_pp r5.xyz, c6.z, -r5
texld r2, r1, s0
pow_pp r1.x, r0.x, c3.x
mul_pp r0.x, r1.x, c2
mad_pp_sat r0.x, r0, c6.y, r4
mul_pp r4.xyz, r0.x, r2
dp3_pp r2.x, r4, c7
mul_pp r2.x, r2, r2
mad_pp r1.x, -r1.x, c4, r0.z
mad_pp_sat r0.w, r1.x, c0, r2.x
mad_pp r5.xyz, r2.x, r5, c0
mad_pp r5.xyz, r4, r5, -r4
add_pp r0.x, -r0, c6.z
mad_pp r4.xyz, r5, c5.x, r4
...
MUL R1.x, R1.w, c[3];
MOV R0.w, c[2].x;
MAD_SAT R0.w, R1.x, c[7].z, R0;
TEX R0.xyz, R2.yzww, texture[0], CUBE;
TXP R2.x, fragment.texcoord[5], texture[1], 2D;
MUL R0.xyz, R0, R0.w;
MOV R2.z, c[7].y;
DP3 R2.y, R0, c[8];
MUL R2.y, R2, R2;
MAD R1.w, -R1, c[5].x, R2.z;
MAD_SAT R1.w, R1, c[1], R2.y;
ADD R1.xyz, R2.z, -c[1];
MAD R1.xyz, R2.y, R1, c[1];
MAD R1.xyz, R0, R1, -R0;
MAD R0.xyz, R1, c[6].x, R0;
ABS R1.x, fragment.texcoord[3].z;
ADD R1.x, R1, -R1.w;
MAX R2.y, fragment.texcoord[3].z, R1.x;
ADD R0.w, -R0, c[7].y;
MUL R1.xyz, R0.w, c[1];
MUL R0.w, R2.y, R2.x;
MUL R2.xyz, R1, c[0];
...
mad_pp r1.x, -r1.x, c5, r0.y
mad_pp_sat r1.x, r1, c1.w, r2
mad_pp r5.xyz, r2.x, r5, c1
mad_pp r5.xyz, r4, r5, -r4
abs_pp r2.x, t3.z
add_pp r2.x, r2, -r1
mad_pp r4.xyz, r5, c6.x, r4
add_pp r0.x, -r0, c7.y
mul_pp r5.xyz, r0.x, c1
max_pp r2.x, t3.z, r2
mul_pp r0.x, r2, r3
mul_pp r2.xyz, r5, c0
mul_pp r3.xyz, r5, t4
...
mov_pp r5.x, c1
mov_pp r0.w, c6
add_pp r6.xyz, c6.w, -r6
texld r2, r1, s0
pow_pp r1.x, r0.x, c3.x
mov_pp r0.x, r1.x
mul_pp r1.x, r0, c2
mad_pp_sat r1.x, r1, c6.y, r5
mul_pp r5.xyz, r1.x, r2
dp3_pp r2.x, r5, c7
mul_pp r2.x, r2, r2
mad_pp r0.x, -r0, c4, r0.w
mad_pp_sat r0.w, r0.x, c0, r2.x
mad_pp r6.xyz, r2.x, r6, c0
...
Program "fp" {
// Fragment combos: 5
//   opengl - ALU: 35 to 47, TEX: 1 to 3
...
RSQ R0.x, R1.x;
MUL R1.x, R0, fragment.texcoord[3].z;
MAD_SAT R0.z, R0, c[1].w, R1.y;
ABS R0.x, R1;
ADD R1.y, R0.x, -R0.z;
ADD R0.y, -R0, c[6].z;
MUL R0.xyz, R0.y, c[1];
...
mad_pp_sat r1.x, r1, c6.z, r3
mul_pp r2.xyz, r2, r1.x
dp3_pp r2.x, r2, c7
mul_pp r2.x, r2, r2
mad_pp_sat r0.x, r0, c1.w, r2
add_pp r1.x, -r1, c6.y
...
MAD R3.xy, fragment.texcoord[4], R1.w, c[7].w;
...
MUL R1.z, R0.x, R0.x;
MOV R0.x, c[6].z;
MAD R0.z, -R1.x, c[5].x, R0.x;
DP3 R0.y, fragment.texcoord[3], fragment.texcoord[3];
RSQ R0.y, R0.y;
MUL R0.x, R0.y, fragment.texcoord[3].z;
MAD_SAT R0.z, R0, c[1].w, R1;
ABS R0.y, R0.x;
ADD R0.y, R0, -R0.z;
ADD R0.z, -R1.y, c[6];
MAX R1.x, R0, R0.y;
