...
public class AntiPiracy : MonoBehaviour
{
    ...
    /// </summary>
    public string[] m_permittedLocalHosts = { "file://", "http://localhost/", "http://localhost:", "https://localhost/", "https://localhost:" };
    ...
    /// </summary>
    /// <param name="permittedHosts">List of hosts permitted to host thegame.</param>
